...
//import com.compomics.util.parameters.identification.search.WebSearchParameters;
...
//     */
//    public Map<String, GalaxyTransferableFile> saveSearchGUIParameters(WebSearchParameters searchParameters, boolean editMode) {
//
//        if (toolsHandler != null) {
...
//     */
//    public void executeWorkFlow(String projectName, String fastaFileId, Set<String> mgfIdsList, Set<String> searchEnginesList, WebSearchParameters searchParameters, Map<String, Boolean> otherSearchParameters) {
