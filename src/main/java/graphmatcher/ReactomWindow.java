...
public class ReactomWindow extends Window{
    ...
    public void visulaizeProtein(String protAccession){
          frame.setSource(new ExternalResource("http://localhost:8084/web-peptide-shaker/VAADIN/reactom/reactomcontainer.html?id="+protAccession.substring(0,protAccession.length()-1)));
