...
//import com.compomics.util.experiment.io.parameters.MarshallableParameter.Type;
...
//import com.compomics.util.io.json.JsonMarshaller1;
////import com.compomics.util.parameters.identification.IdentificationParameters;
////import  com.compomics.util.parameters.identification.IdentificationParameters.CURRENT_VERSION;
//
...
// */
//public class WebSearchParameters extends ExperimentObject implements MarshallableParameter {
//
//    /**
...
//     */
//    public  final String[] implementedForwardIons = {"a", "b", "c"};
//    /**
//     * Convenience array for rewind ion type selection.
//     */
//    public  final String[] implementedRewindIons = {"x", "y", "z"};
//    /**
...
//     */
//    public  final int preferredMaxVariableModifications = 6;
//    /**
//     * The preferred minimal number of protein sequences.
//     */
//    public  final int preferredMinSequences = 1000;
//    /**
...
//     * Constructor.
//     *
//     * @param WebSearchParameters the search parameter to base the search
//     * parameters on.
//     */
//    public WebSearchParameters(WebSearchParameters searchParameters) {
//
...
//     */
//    public WebSearchParameters(SearchParameters searchParameters, HashMap<String, Modification> modificationMap) {
//
//        // Set values from the given parameters
//        if( searchParameters.getPrecursorAccuracyType().toString().equalsIgnoreCase( searchParameters.getPrecursorAccuracyType().DA.toString())){
//         this.precursorAccuracyType =WebSearchParameters.MassAccuracyType.DA;
//        }else{
//         this.precursorAccuracyType =WebSearchParameters.MassAccuracyType.PPM;
//        }
//         if( searchParameters.getFragmentAccuracyType().toString().equalsIgnoreCase( searchParameters.getFragmentAccuracyType().DA.toString())){
//         this.fragmentAccuracyType =WebSearchParameters.MassAccuracyType.DA;
//        }else{
//         this.fragmentAccuracyType =WebSearchParameters.MassAccuracyType.PPM;
//        }
//        this.precursorTolerance = searchParameters.getPrecursorAccuracy();
//        this.fragmentIonMZTolerance = searchParameters.getFragmentIonAccuracy();
//        this.modificationParameters = new ModificationParameters(searchParameters.getPtmSettings(),modificationMap);
//        
//        this.digestionParameters =new DigestionParameters(searchParameters.getDigestionPreferences());
//        this.forwardIons = new ArrayList<>(searchParameters.getForwardIons());
//        this.rewindIons = new ArrayList<>(searchParameters.getRewindIons());
//        this.minChargeSearched = searchParameters.getMinChargeSearched().value;
//        this.maxChargeSearched = searchParameters.getMaxChargeSearched().value;
//        this.minIsotopicCorrection = searchParameters.getMinIsotopicCorrection();
//        this.maxIsotopicCorrection = searchParameters.getMaxIsotopicCorrection();
//        this.refMass = searchParameters.getRefMass();
//
//        // Set advanced parameters
//        setAndConvertDefaultAdvancedSettings(searchParameters);
//    }
//
//    
//    
...
//     * settings from
//     */
//    public void setAndConvertDefaultAdvancedSettings(SearchParameters searchParameters) {
//
...
//     * settings from
//     */
//    public void setDefaultAdvancedSettings(WebSearchParameters searchParameters) {
//
//        if (searchParameters == null || searchParameters.getIdentificationAlgorithmParameter(Advocate.omssa.getIndex()) == null) {
//            setIdentificationAlgorithmParameter(Advocate.omssa.getIndex(), new OmssaParameters());
//        } else {
...
//     */
//    public  void saveIdentificationParameters(WebSearchParameters searchParameters, File searchParametersFile) throws IOException {
...
//
//        WebSearchParameters defaultParameters = new WebSearchParameters();
...
//     */
//    public boolean equals(WebSearchParameters otherSearchParameters) {
//
...
//    }
//    
//    private WebSearchParameters convertToWebSearchParameters(SearchParameters sp){
//    
//    WebSearchParameters webSP = new WebSearchParameters(sp,modificationFactory.getModificationMap());       
//    return webSP;
//    }
...
//     */
//    public  WebSearchParameters getIdentificationParameters(File searchParametersFile) throws IOException, ClassNotFoundException {
//        Object savedObject=null;
//
//        try {
//
//            // Try as json file
//            JsonMarshaller1 jsonMarshaller = new JsonMarshaller1();
...
//            System.out.println("object was read ?? ------------------------------------------------> "+dummyParameters.getType());
////            if (dummyParameters.getType() == MarshallableParameter.Type.search_parameters) {
////                expectedObjectType = WebSearchParameters.class;
////                
////                System.out.println("com.compomics.util.parameters.identification.search.WebSearchParameters.getIdentificationParameters()---2");
...
//                savedObject = jsonMarshaller.fromJson(expectedObjectType, searchParametersFile);
//                System.out.println("com.compomics.util.parameters.identification.search.WebSearchParameters.getIdentificationParameters()");
//            } 
////else {
...
//        }
//
//        WebSearchParameters searchParameters;
//        if (savedObject instanceof WebSearchParameters) {
//            searchParameters = (WebSearchParameters) savedObject;
...
//            SearchParameters sp = identificationParameters.getSearchParameters();
//            searchParameters = this.convertToWebSearchParameters(sp);
//        } else {
