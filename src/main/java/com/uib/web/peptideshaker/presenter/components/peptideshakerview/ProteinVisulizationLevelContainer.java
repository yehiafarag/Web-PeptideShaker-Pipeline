...
import com.uib.web.peptideshaker.presenter.components.peptideshakerview.components.coverage.ProteinCoverageComponent;
        ...
        selectedProteinGraph = new ProteinsPeptidesGraphComponent() {
            ...
            public void selectedItem(Set<Object> selectedItems, Set<Object> selectedChildsItems) {
                ...
                if (selectedItems.size() == 1) {
                    ...
                    for (PeptideObject peptide : this.getPeptidesNodes().values()) {
                        if (peptide.getProteinsSet().contains(protien.getAccession())) {
