...
//    private AbsoluteLayout moffFileContainerLayout;
     ...
     */
    public UserUploadFilesContainer(SelectionManager Selection_Manager, BigSideBtn uploadOwnDataBtn) {
        ...
        subContainerLayout.setHeight(396, Unit.PIXELS);
...
//        subContainerLayout.addComponent(mzIdentMLContainer, "left:25px;top:454px;right:25px");
        ...
        subContainerLayout.addComponent(projectVisulizationButtonsContainer, "left:25px;top:330px;right:25px");
    ...
    private AbsoluteLayout initializeProjectInputFilesLayout() {
        ...
        initTextFilesInputContainer.setHeight(116, Unit.PIXELS);
...
//        initTextFilesInputContainer.addComponent(moffFileContainerLayout, "left:15px;top:105px;right:15px");
    ...
    private AbsoluteLayout initUploaderField(String title, String format) {
        if (uploadedFileMap.containsKey(title.replace("File", "").trim())) {
//            ((File) uploadedFileMap.remove(title.replace("File", "").trim()).getUploadedFile()).delete();
        }
        ...
        uploaderFieldContainer.addComponent(uploader, "left:115px");
        uploader.addUploaderFilter(format);
        uploaderFieldContainer.addComponent(validationProgressLabel, "right:38px; top:4px");
        uploaderFieldContainer.addComponent(progressBar, "left:179px;top:10px;right:68px");
        uploaderFieldContainer.addComponent(uploadedFileLabel, "left:179px;top:5px;right:68px;bottom:5px");
        Help inforNote = new Help("LoloBaba", "Sample " + title);
        uploaderFieldContainer.addComponent(inforNote);
        uploaderFieldContainer.addComponent(inforNote, "right:5px");
