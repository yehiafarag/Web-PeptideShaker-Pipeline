...
public class GalaxyFileObject {
    ...
    private String type;
    /**
     * File ID on NeLS Storage system .
     */
    ...
    private double size;
    /**
     * File available on NeLS storage system.
     */
    ...
    /**
     * Get File ID on NeLS Storage system .
     *
     * @return File ID on NeLS Storage system .
     */
    ...
    /**
     * Set File ID on NeLS Storage system .
     *
     * @param nelsKey File ID on NeLS Storage system .
     * @param exitType the file extension type
     */
    ...
    /**
     * Check file available on NeLS Storage system.
     *
     * @return file available on NeLS
     */
    ...
    /**
     * Set file available on NeLS Storage system.
     *
     * @param availableOnNels file available on NeLS
     */
