...
//import temp.suspend.com.compomics.util.experiment.biology.modifications.Modification;
...
//     * @param modificationParameters the modification profile
//     */
//    public ModificationParameters(PtmSettings modificationParameters, HashMap<String, Modification> modificationMap) {
//        fixedModifications = modificationParameters.getFixedModifications();
//        variableModifications = modificationParameters.getVariableModifications();
//        refinementFixedModifications = modificationParameters.getRefinementFixedModifications();
//        refinementVariableModifications = modificationParameters.getRefinementVariableModifications();
//        HashMap<String, Color> awtColorMap = modificationParameters.getColors();
//        colors = convertColorMap(awtColorMap);
//        backUp = converPTMToModificationMap(modificationParameters.getBackedUpPtmsMap(),modificationMap);
//    }
//
//    /**
...
//    }
//
//    private HashMap<String, Integer> convertColorMap(HashMap<String, Color> awtColorMap) {
//        HashMap<String, Integer> colorMap = new HashMap<>();
//        awtColorMap.keySet().forEach((key) -> {
//            colorMap.put(key, awtColorMap.get(key).getRGB());
//        });
//
//        return colorMap;
//
//    }
//
//    private HashMap<String, Modification> converPTMToModificationMap(HashMap<String, PTM> ptmMap,HashMap<String, Modification> fullmodificationMap) {
//        HashMap<String, Modification> modificationMap = new HashMap<>();
//        ptmMap.keySet().forEach((key) -> {                     
//            Modification m = fullmodificationMap.get(key);
//            modificationMap.put(key, m);
//        });
//
