...
//   
//     */
//    public  DigestionParameters (DigestionPreferences digestionParameters) {
//            
//        CleavageParameter cp = CleavageParameter.getCleavageParameters(digestionParameters.getCleavagePreference().index);        
//        DigestionParameters.this.setCleavageParameter(cp);
//        if (cp == DigestionParameters.CleavageParameter.enzyme) {
//            for (Enzyme enzyme : digestionParameters.getEnzymes()) {
//                DigestionParameters.this.addEnzyme(enzyme);
//                String enzymeName = enzyme.getName();
//                DigestionParameters.this.setSpecificity(enzymeName, DigestionParameters.this.getSpecificity(enzymeName));
//                DigestionParameters.this.setnMissedCleavages(enzymeName, digestionParameters.getnMissedCleavages(enzymeName));
//            }
//        }
//    }
//    /**
